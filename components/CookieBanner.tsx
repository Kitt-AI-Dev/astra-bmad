...
export function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-surface border-t border-border px-6 py-4">
      <div className="max-w-[700px] mx-auto flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-4">
        <p className="text-[13px] font-mono text-text-secondary sm:flex-1 sm:min-w-0">

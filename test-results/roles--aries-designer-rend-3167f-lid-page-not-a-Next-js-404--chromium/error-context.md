...
- Name: roles.spec.ts >> /aries/designer renders a valid page (not a Next.js 404)
- Location: tests/roles.spec.ts:18:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/aries/designer
Call log:
  - navigating to "http://localhost:3000/aries/designer", waiting until "load"

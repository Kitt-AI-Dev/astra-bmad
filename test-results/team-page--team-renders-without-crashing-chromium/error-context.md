...
- Name: team-page.spec.ts >> /team renders without crashing
- Location: tests/team-page.spec.ts:18:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/team
Call log:

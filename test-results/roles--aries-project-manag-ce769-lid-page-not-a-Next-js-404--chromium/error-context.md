...
- Name: roles.spec.ts >> /aries/project-manager renders a valid page (not a Next.js 404)
- Location: tests/roles.spec.ts:18:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/aries/project-manager
Call log:
  - navigating to "http://localhost:3000/aries/project-manager", waiting until "load"

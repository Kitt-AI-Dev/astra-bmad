...
- Name: readingcard-redesign-10-2.spec.ts >> null state renders correctly for unknown date
- Location: tests/readingcard-redesign-10-2.spec.ts:126:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/aries/frontend/2099-01-01
Call log:
  - navigating to "http://localhost:3000/aries/frontend/2099-01-01", waiting until "load"

...
- Name: roles.spec.ts >> /aries/pr-manager renders a valid page (not a Next.js 404)
- Location: tests/roles.spec.ts:18:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/aries/pr-manager
Call log:
  - navigating to "http://localhost:3000/aries/pr-manager", waiting until "load"

...
| `NEXT_PUBLIC_TELEGRAM_BOT_URL` | *(Optional)* Your bot's Telegram URL, e.g. `https://t.me/a404tuneBot`. When set, a `$ subscribe` button appears on reading pages that opens the bot with the user's sign, role, and timezone pre-filled. Leave blank to hide it. |
